...
const PresalePage = () => {
  const [presaleState, setState] = useState({
    sendAmount: 0,
    receiveAmount: 0,
  });
    ...
    try {
      ...
      const buyInstruction = new TransactionInstruction({
        ...
        data: Buffer.from(
          Uint8Array.of(
            1,
            ...new BN(presaleState.sendAmount * LAMPORTS_PER_SOL).toArray(
              "le",
              8
            )
          )
        ...
        keys: [
          ...
          {
            pubkey: new PublicKey(PRESALE_TOKEN_ACCOUNT_PUB_KEY),
            isSigner: false,
            isWritable: true,
          },
          {
      ...
      <div className={`${styles.section}`}>
        <main className={`text-center text-[#fff] ${styles.main} `}>
          ...
          >
            <div className={`flex flex-col`}>
              ...
              <input
                ...
                value={presaleState.sendAmount}
                onChange={(e) =>
                  setState({
                    sendAmount: e.target.value,
                    receiveAmount: e.target.value * TOKEN_PRICE_PER_SOL,
                  })
                }
              />
            </div>
            ...
            <div className="flex gap-[0.5rem] items-center">
              ...
              <select
                className="text-[#0D0D36] font-bold bg-[#fff] py-[0.5rem] px-[1.2rem] outline-none rounded-md"
                defaultValue={"SOL"}
              >
          ...
          <h2 className="text-[#000] font-bold">
            1 SOL ={" "}
            <span className="font-bold">{TOKEN_PRICE_PER_SOL} CUCK</span>
          </h2>
          ...
          >
            <div className={`flex flex-col`}>
              ...
              <input
                type="text"
                className={`${styles.input}`}
                value={presaleState.receiveAmount}
                onChange={(e) =>
                  setState({
                    sendAmount: e.target.value / TOKEN_PRICE_PER_SOL,
            ...
            <div className="flex gap-[0.5rem] items-center">
              ...
              <select
                className="text-[#0D0D36] bg-[#fff] font-bold py-[0.5rem] px-[1.2rem] rounded-md"
                defaultValue={"CUCK"}
              >
          ...
          <button
            ...
            disabled={
              !publicKey ||
              presaleState.sendAmount == 0 ||
              presaleState.receiveAmount == 0
                ? true
                : false
            }
          >
